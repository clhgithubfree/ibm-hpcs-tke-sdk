...
/*----------------------------------------------------------------------------*/
func CommitPendingWK(ci common.CommonInputs, de common.DomainEntry,
	...
	htpRequestString, err := CommitPendingWKReq(ci, de, domainInfo.NewMKVP,
...
/*----------------------------------------------------------------------------*/
func CommitPendingWKReq(ci common.CommonInputs, de common.DomainEntry,
	vp []byte, sigkeys []string, sigkeySkis []string, sigkeyTokens []string) (string, error) {
